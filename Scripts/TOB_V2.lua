...
https://www.roblox.com/catalog/17331373966/WHITE-STERN-FACE <<perfect (Accessory (MeshPartAccessory))
please check if the 

import hats and parent to this script if in studio
if else you might have to buy them or somehow spawn them

]]

-----dont change anything below unless you know what youre doing! planning to add physics somehow sometime.----- 
...
cc, customcolor = false, BrickColor.new("White") --custom color of the breasts. first value for custom, second for the color.
cc2, customcolor2 = false, BrickColor.new("Black") --custom color of the vagina and nipples. first value for custom, second for the color.
...
novag = true --would be best if you have nopants set to true. same goes reverse.
